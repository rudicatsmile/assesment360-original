...
<body class="min-h-screen bg-zinc-100 text-zinc-900">
    <main class="mx-auto flex min-h-screen max-w-2xl items-center justify-center p-6">
        <section class="w-full rounded-2xl border border-zinc-200 bg-white p-8 text-center shadow-sm">
            <p class="text-xs uppercase tracking-wide text-zinc-500">Error 500</p>
            <h1 class="mt-2 text-3xl font-semibold">Terjadi Kesalahan Server</h1>
            <p class="mt-3 text-sm text-zinc-600">Silakan coba lagi beberapa saat atau hubungi admin sekolah.</p>
